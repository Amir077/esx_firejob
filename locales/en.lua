Locales['en'] = {
  ...
  ['get_weapon'] = 'withdraw gear from armory',
  ['put_weapon'] = 'store gear in armory',
  ['buy_weapons'] = 'buy gear',
  ['armory'] = 'armory',
  ['open_armory'] = 'press ~INPUT_CONTEXT~ to access the ~y~Armory~s~.',
  ['armory_owned'] = 'owned',
  ['armory_free'] = 'free',
  ['armory_item'] = '$%s',
  ['armory_weapontitle'] = 'armory - Buy gear',
  ['armory_componenttitle'] = 'armory - gear attatchments',
  ['armory_bought'] = 'you bought an ~y~%s~s~ for ~r~$%s~s~',
  ['armory_money'] = 'you cannot afford that gear',
  ['armory_hascomponent'] = 'you have that attatchment equiped!',
  ['get_weapon_menu'] = 'armory - Withdraw gear',
  ['put_weapon_menu'] = 'armory - Store gear',
  -- Vehicles
...
\
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~Fire~s~',
  -- Vehicle interaction
  ...
  ['owner'] = 'owner: %s',
  -- Chief Menu
  ['open_chiefmenu'] = 'press ~INPUT_CONTEXT~ to open the menu',
